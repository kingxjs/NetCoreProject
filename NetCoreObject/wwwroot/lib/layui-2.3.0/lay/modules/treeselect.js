...
layui.define(['layer', 'tree'], function (exports) {
    ...
    * 初始化下拉树选择框
    */
    TreeSelect.prototype.init = function (elem, clickfun) {
        var that = this,
            TIPS = '请选择',
            ...
            events = function (reElem, disabled) {
                var select = $(this),
                    ...
                    defaultVal = elem.val(),
                    required = elem.attr("lay-verify") =="required";
                    
                if (!required) {
                    that.options.data.unshift({ id: "", name: placeholder})
                }


                var setVal = function (data, defaultVal, input) {
                    $.each(data,
                        function (i, o) {
                            if (o.id === defaultVal) {
                                input.val(o.name);
                                ...
                                if (o.children) {
                                    if (o.children.length > 0) {
                                        setVal(o.children, defaultVal, input)
                                    }
                                }
                            }
                        });
                }
                setVal(that.options.data, defaultVal, input);
    ...
    function isJson(obj) {
        ...
        return typeof (obj) == "object" && Object.prototype.toString.call(obj).toLowerCase() == "[object array]" && obj.length;
